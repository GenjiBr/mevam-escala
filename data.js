...
window.FUNCOES = {
  pregador:        { label: 'Pregador',          color: '#C0392B', icon: '🎤', short: 'PR' },
  vocal_backing:   { label: 'Vocal / Backing',   color: '#8E44AD', icon: '🎵', short: 'VB' },
  vocal_principal: { label: 'Vocal Principal',   color: '#9B59B6', icon: '🎙️', short: 'VP' },
  ...
  sonoplasta:      { label: 'Sonoplasta',        color: '#1ABC9C', icon: '🎚️', short: 'SO' },
  projecao:        { label: 'Projeção',          color: '#9AA4B0', icon: '📽️', short: 'PJ' },
};

window.MEMBROS_INICIAIS = [
  { id: 'm1',  nome: 'Lucas Andrade',     iniciais: 'LA', func: 'ministro',        secundarias: ['vocal_principal','violao'], status: 'ativo', tom: '#F39C12' },
  { id: 'm2',  nome: 'Pr. Daniel Costa',  iniciais: 'DC', func: 'pregador',        secundarias: [], status: 'ativo', tom: '#C0392B' },
  { id: 'm3',  nome: 'Maria Helena',      iniciais: 'MH', func: 'vocal_principal', secundarias: ['vocal_backing'], status: 'ativo', tom: '#9B59B6' },
  ...
  { id: 'm10', nome: 'Pr. Marcos Silva',  iniciais: 'MS', func: 'pregador',        secundarias: ['ministro'], status: 'ativo', tom: '#C0392B' },
  { id: 'm11', nome: 'Davi Souza',        iniciais: 'DS', func: 'sonoplasta',      secundarias: [], status: 'ativo', tom: '#1ABC9C' },
  { id: 'm12', nome: 'Letícia Borges',    iniciais: 'LB', func: 'projecao',        secundarias: ['vocal_backing'], status: 'ativo', tom: '#9AA4B0' },
  { id: 'm13', nome: 'João Vitor',        iniciais: 'JV', func: 'vocal_backing',   secundarias: ['violao'], status: 'visitante', tom: '#8E44AD' },
  { id: 'm14', nome: 'Beatriz Nunes',     iniciais: 'BN', func: 'vocal_principal', secundarias: [], status: 'inativo', tom: '#9B59B6' },
];
...
window.CULTOS_INICIAIS = [
  { id: 'c1', data: fmt(nextWeekday(HOJE, 0, 0)), titulo: 'Culto Domingo Manhã',  horario: '09:00', cor: '#3B82F6',
    escalados: { ministro:'m1', pregador:'m10', vocal_principal:'m3', vocal_backing:['m9','m13'], guitarra:'m4', baixo:'m5', bateria:'m6', teclado:'m7', violao:'m8', sonoplasta:'m11', projecao:'m12' } },
  { id: 'c2', data: fmt(nextWeekday(HOJE, 0, 0)), titulo: 'Culto Domingo Noite',  horario: '18:30', cor: '#7C5CFF',
    escalados: { ministro:'m1', pregador:'m2', vocal_principal:'m3', vocal_backing:['m9'], guitarra:'m4', baixo:'m5', bateria:'m6', teclado:'m7', violao:null, sonoplasta:'m11', projecao:'m12' } },
  { id: 'c3', data: fmt(nextWeekday(HOJE, 3, 0)), titulo: 'Culto de Quarta',      horario: '20:00', cor: '#4FD1C5',
    escalados: { ministro:'m1', pregador:'m10', vocal_principal:null, vocal_backing:['m9'], guitarra:null, baixo:'m5', bateria:'m6', teclado:'m7', violao:'m8', sonoplasta:'m11', projecao:'m12' } },
  { id: 'c4', data: fmt(nextWeekday(HOJE, 0, 1)), titulo: 'Culto Domingo Manhã',  horario: '09:00', cor: '#3B82F6',
    escalados: { ministro:'m1', pregador:'m2', vocal_principal:'m3', vocal_backing:['m9','m13'], guitarra:'m4', baixo:'m5', bateria:'m6', teclado:'m7', violao:'m8', sonoplasta:'m11', projecao:'m12' } },
  { id: 'c5', data: fmt(nextWeekday(HOJE, 0, 1)), titulo: 'Culto Domingo Noite',  horario: '18:30', cor: '#7C5CFF',
    escalados: { ministro:'m1', pregador:'m10', vocal_principal:'m3', vocal_backing:['m9'], guitarra:'m4', baixo:'m5', bateria:'m6', teclado:'m7', violao:'m8', sonoplasta:'m11', projecao:'m12' } },
  { id: 'c6', data: fmt(nextWeekday(HOJE, 3, 1)), titulo: 'Culto de Quarta',      horario: '20:00', cor: '#4FD1C5',
    escalados: { ministro:'m1', pregador:'m2', vocal_principal:'m3', vocal_backing:['m9'], guitarra:null, baixo:'m5', bateria:'m6', teclado:'m7', violao:'m8', sonoplasta:'m11', projecao:'m12' } },
];
