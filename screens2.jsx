...
function EscalaScreen({ state, dispatch, usuario, equipe, onToast, onPerfilClick, onExcluirEquipe, onSairEquipe }) {
  ...
  const [showMusicas, setShowMusicas] = useState(
  ...
  return (
    <div style={screenWrap}>
      ...
      {showMusicas && <MusicasSheet state={state} dispatch={dispatch} usuario={usuario} equipe={equipe} onToast={onToast} onClose={() => { setShowMusicas(false); window.location.hash = 'escala'; }} />}
